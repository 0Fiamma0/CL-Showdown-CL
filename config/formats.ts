...
export const Formats: FormatList = [
	...
	///////////////////////////////////////////////////////////////////
	{
		section: "Formati Custom CL",
	},
	{
		name: "[CL] Custom Game Lotta In Triplo",
	...
	{
		name: "[CL] Custom Game Co-Op 3-3vs3-3",
		mod: "gen8",
		gameType: 'multi',
		searchShow: false,
		tournamentShow: false,
		rated: false,
		ruleset: ['Team Preview', 'Cancel Mod', 'Max Team Size = 6', 'Max Move Count = 24', 'Max Level = 9999', 'Picked Team Size = 3'],
		
		
		
	},
	{
		name: "[CL] Custom Game Co-Op 6-6vs6-6",
		mod: "gen8",
		gameType: 'multi',
		searchShow: false,
		tournamentShow: false,
		rated: false,
		ruleset: ['Team Preview', 'Cancel Mod', 'Max Team Size = 6', 'Max Move Count = 24', 'Max Level = 9999'],
